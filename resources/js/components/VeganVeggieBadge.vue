<template>
    <span>
        ...
        <button v-if="is_veggie && is_vegan" class="tooltip text-white rounded-6 bg-cyan w-6 h-6 ml--2 z-0">
            v
            <span class="tooltiptext">{{ $t('ingredients_table.is_vegan')}}</span>
        </button>
        <button v-else-if="is_vegan" class="tooltip text-white rounded-6 bg-cyan w-6 h-6 z-0">
            v
            <span class="tooltiptext">{{ $t('ingredients_table.is_vegan')}}</span>
        </button>
    </span>
